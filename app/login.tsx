  ...
  return (
    <ThemedView style={[styles.screenContainer, styles.centeredColumnFlexbox]}>
      ...
      <ThemedView style={[styles.loginContentDiv, styles.centeredColumnFlexbox]}>
        ...
        <StyledTextInput placeholder={"email@domain.com"} style={{width: standardWidth}} placeholderTextColor={Colors.lightgrey}/>
        <Link style={[styles.button, styles.continueButton]} href={"/"}>
